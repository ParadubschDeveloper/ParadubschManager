...
public class Message {
    ...
    public enum Constant implements BaseMessageType {
        ...
        JUNGLE_LOG("constantJungleLog", "Jungelholz"),
        BIRCH_LOG("constantBirchLog", "Birkenholz"),
        DARK_OAK_LOG("constantDarkOakLog", "Dunkleichenholz"),
        DIRT("constantDirt", "Erde"),
        COBBLESTONE("constantCobblestone", "Bruchstein"),
        STONE("constantStone", "Stein"),
        BLACKSTONE("constantBlackstone", "Schwarzstein"),
        DEEPSLATE("constantDeepslate", "Tiefgestein"),
        NETHER_BRICKS("constantNetherBricks", "Netherziegel"),
        END_STONE("constantEndStone", "Endgestein"),
        SAND("constantSand", "Sand"),
        GRAVEL("constantGravel", "Kies"),
        CLAY("constantClay", "Lehm"),
        SUGAR_CANE("constantSugarCane", "Zuckerrohr"),
        WHEAT("constantWheat", "Weizen"),
        NETHER_WART("constantNetherWart", "Netherwarze"),
        OAK_LEAVES("constantOakLeaves", "Eichenblätter"),
        SPRUCE_LEAVES("constantSpruceLeaves", "Fichtenblätter"),
        BIRCH_LEAVES("constantBirchLeaves", "Birkenblätter"),
        JUNGLE_LEAVES("constantJungleLeaves", "Jungelblätter"),
        DARK_OAK_LEAVES("constantDarkOakLeaves", "Dunkleichenblätter"),
        ACACIA_LEAVES("constantAcaciaLeaves", "Akazienblätter"),
        COCOA_BEANS("constantCocoaBeans", "Kakaobohnen"),
        CACTUS("constantCactus", "Kaktus"),
        CHORUS_FRUIT("constantChorusFruit", "Chorusfrucht"),
        REDSTONE("constantRedstone", "Redstone"),
        IRON_INGOT("constantIronIngot", "Eisenbarren"),
        GOLD_INGOT("constantGoldIngot", "Goldbarren"),
        COAL("constantCoal", "Kohle"),
        EMERALD("constantEmerald", "Smaragd"),
        LAPIS_LAZULI("constantLapisLazuli", "Lapislazuli"),
        NETHERITE_INGOT("constantNetherriteIngot", "Netherrite Barren"),
        ROSE_BUSH("constantRoseBush", "Rosenstrauch"),
        DANDELION("constantDandelion", "Gänseblümchen"),
        POPPY("constantPoppy", "Mohnblume"),
        INK_SAC("constantInkSac", "Tintensack"),
        PRISMARINE_SHARD("constantPrismarineShard", "Prismarinsplitter"),
        BONE("constantBone", "Knochen"),
        BLAZE_ROD("constantBlazeRod", "Lohnenstab"),
        STRING("constantString", "Faden"),
        SHULKER_SHELL("constantShulkerShell", "Shulkerpanzer");
